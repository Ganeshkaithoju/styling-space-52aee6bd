...
const consultationSchema = z.object({
  ...
  service_interest: z.string().trim().max(120).optional().nullable(),
  project_type: z.string().trim().max(120).optional().nullable(),
  project_scope: z.string().trim().max(120).optional().nullable(),
  timeline: z.string().trim().max(120).optional().nullable(),
  budget_range: z.string().trim().max(120).optional().nullable(),
  location: z.string().trim().max(200).optional().nullable(),
  property_address: z.string().trim().max(300).optional().nullable(),
  preferred_date: z.string().trim().max(40).optional().nullable(),
  preferred_time: z.string().trim().max(60).optional().nullable(),
